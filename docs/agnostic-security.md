...
|---------|-----------|--------------|--------|
| **Base BambooClaw Core** | 3.4MB | <5MB | ✅ Current |
...
| Hardware | RAM | BambooClaw Core (base) | BambooClaw Core (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
...
**Even with full security, BambooClaw Core uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### BambooClaw Core's Core Promise: Swap Anything
