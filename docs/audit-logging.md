# Audit Logging for BambooClaw Core
...
## Problem
BambooClaw Core logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/BambooClaw Core/audit.key"
...
BambooClaw Core audit --user @alice

# Show all high-risk commands
BambooClaw Core audit --risk high

# Show violations from last 24 hours
BambooClaw Core audit --since 24h --violations-only

# Export to JSON for analysis
BambooClaw Core audit --format json --output audit.json
