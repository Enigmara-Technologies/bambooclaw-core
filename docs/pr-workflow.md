# BambooClaw Core PR Workflow (High-Volume Collaboration)

This document defines how BambooClaw Core handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to BambooClaw Core/project-native labels.
...
- Confirm any required identity-like wording uses BambooClaw Core/project-native terminology.
