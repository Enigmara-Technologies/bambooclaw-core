# Resource Limits for BambooClaw Core
...
## Problem
BambooClaw Core has rate limiting (20 actions/hour) but no resource caps. A runaway agent could:
...
Automatically create a cgroup for BambooClaw Core with limits.
