...
```bash
gh api repos/BambooClaw Core-labs/BambooClaw Core/actions/permissions
gh api repos/BambooClaw Core-labs/BambooClaw Core/actions/permissions/selected-actions
```
