...
//!
//! A standalone robotics toolkit that integrates with BambooClaw Core for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  BambooClaw Core AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use BambooClaw Core_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of BambooClaw Core. It defines its own
//! `Tool` trait that is compatible with BambooClaw Core's but doesn't require it.
//!
//! ## Safety
//!
