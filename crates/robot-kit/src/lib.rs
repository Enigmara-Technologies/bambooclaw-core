//! # BambooClawCore Robot Kit
//!
//! A standalone robotics toolkit that integrates with BambooClawCore for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  BambooClawCore AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use BambooClawCore_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of BambooClawCore. It defines its own
//! `Tool` trait that is compatible with BambooClawCore's but doesn't require it.
//!
//! ## Safety
//!
