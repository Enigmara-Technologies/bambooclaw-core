# AGENTS.md — BambooClaw Core Agent Engineering Protocol
...
BambooClaw Core is a Rust-first autonomous agent runtime optimized for:
...
- If identity-like naming is required in tests/examples, use BambooClaw Core-native labels only (`BambooClaw CoreAgent`, `BambooClaw Core_user`, `BambooClaw Core_node`).
...
- If identity-like context is unavoidable, use BambooClaw Core-scoped roles/labels only (for example: `BambooClaw CoreAgent`, `BambooClaw CoreOperator`, `BambooClaw Core_user`) and avoid real-world personas.
- Recommended identity-safe naming palette (use when identity-like context is required):
    - actor labels: `BambooClaw CoreAgent`, `BambooClaw CoreOperator`, `BambooClaw CoreMaintainer`, `BambooClaw Core_user`
    - service/runtime labels: `BambooClaw Core_bot`, `BambooClaw Core_service`, `BambooClaw Core_runtime`, `BambooClaw Core_node`
    - environment labels: `BambooClaw Core_project`, `BambooClaw Core_workspace`, `BambooClaw Core_channel`
