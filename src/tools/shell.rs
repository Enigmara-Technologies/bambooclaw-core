...
mod tests {
    ...
    async fn shell_does_not_leak_api_key() {
        ...
        let _g2 = EnvGuard::set("BambooClawCore_API_KEY", "sk-test-secret-67890");
        ...
        assert!(
            ...
            "BambooClawCore_API_KEY leaked to shell command output"
        );
    }
    ...
    async fn shell_requires_approval_for_medium_risk_command() {
        ...
        let denied = tool
            .execute(json!({"command": "touch BambooClawCore_shell_approval_test"}))
            .await
        ...
        let allowed = tool
            .execute(json!({
                "command": "touch BambooClawCore_shell_approval_test",
                "approved": true
            }))
            .await
        ...
        let _ =
            tokio::fs::remove_file(std::env::temp_dir().join("BambooClawCore_shell_approval_test")).await;
    }
