...
const SNAPSHOT_HEADER: &str = "# 🧠 BambooClaw Core Memory Snapshot\n\n\
    > Auto-generated by BambooClaw Core. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 BambooClaw Core Memory Snapshot

> Auto-generated by BambooClaw Core.
...
I am BambooClaw Core, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 BambooClaw Core Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
