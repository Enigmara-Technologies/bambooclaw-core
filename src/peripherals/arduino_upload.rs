...
//! sketch code and calls this tool. BambooClaw Core compiles and uploads it — no
...
impl Tool for ArduinoUploadTool {
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        let sketch_name = "BambooClaw Core_sketch";
        let temp_dir = std::env::temp_dir().join(format!("BambooClaw Core_{}", uuid::Uuid::new_v4()));
