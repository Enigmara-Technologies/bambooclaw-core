# BambooClaw Core ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for BambooClaw Core edge scenarios on ESP32.
...
```text
firmware/BambooClaw Core-esp32-ui/
...
```bash
cd firmware/BambooClaw Core-esp32-ui
cargo build --release
...
3. Connect UI state with BambooClaw Core edge/runtime messaging
...
- [BambooClaw Core Hardware Design](../../docs/hardware-peripherals-design.md)
