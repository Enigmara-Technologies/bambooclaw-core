...
Step-by-step setup for building the BambooClaw Core ESP32 firmware. Follow this if you run into issues.
...
- Run `cargo build` from `firmware/BambooClaw Core-esp32`
