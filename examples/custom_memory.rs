//! Example: Implementing a custom Memory backend for BambooClawCore
//!
...
// ── Re-define the trait types (in your app, import from BambooClawCore::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 BambooClawCore Memory Demo — InMemoryBackend\n");
