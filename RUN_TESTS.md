...
```bash
cd /Users/abdzsam/BambooClaw Core
...
```bash
# Check config
cat ~/.BambooClaw Core/config.toml | grep -A 5 telegram
...
| Health check | <5s | `time BambooClaw Core channel doctor` |
...
5. **Monitor logs** for any issues:
   ...
   # or
   RUST_LOG=info BambooClaw Core channel start
   ```
...
- Issues: https://github.com/theonlyhennygod/BambooClaw Core/issues
- Docs: `./TESTING_TELEGRAM.md`
- Help: `BambooClaw Core --help`
