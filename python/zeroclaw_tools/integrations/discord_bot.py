"""
Discord bot integration for BambooClaw Core.
"""
...
class DiscordBot:
    """
    Discord bot powered by BambooClaw Core agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install BambooClaw Core-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"BambooClaw Core Discord Bot ready: {self.client.user}")
