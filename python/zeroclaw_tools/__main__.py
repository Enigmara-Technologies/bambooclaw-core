"""
CLI entry point for BambooClaw Core-tools.
"""
...
DEFAULT_SYSTEM_PROMPT = """You are BambooClaw Core, an AI assistant with full system access. Use tools to accomplish tasks.
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="BambooClaw Core Tools - LangGraph-based tool calling for LLMs"
    )
    parser.add_argument(
        "message",
        nargs="*",
...
def main(argv: list[str] | None = None):
    ...
    if args.interactive:
        print("BambooClaw Core Tools CLI (Interactive Mode)")
