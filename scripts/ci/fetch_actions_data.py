...
Options:
    ...
    --repo OWNER/NAME   Repository (default: BambooClaw Core-labs/BambooClaw Core)
...
def parse_args():
    ...
    parser.add_argument(
        "--repo",
        default="BambooClaw Core-labs/BambooClaw Core",
        help="Repository in OWNER/NAME format (default: BambooClaw Core-labs/BambooClaw Core)",
    )
